    ...
    if ($result) {
        ...
        if ($sql_historial) {
            ...
            if ($sql_delete) {
                ...
                $body = sprintf(
                    '<h1>Solicitud Aprobada</h1><p>Su solicitud ha sido aprobada con los siguientes detalles:</p><ul><li>ID de Solicitud: %s</li><li>Solicitante: %s</li><li>Aula Solicitada: %s</li><li>Fecha y Hora de Inicio: %s</li><li>Fecha y Hora de Fin: %s</li><li>Aprobada por: %s</li></ul>',
                    $cod_ticket,
                    $solicitante,
                    $aula_solicitada,
                    $fecha_inicio,
