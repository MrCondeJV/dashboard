    ...
    if ($result) {
        ...
        if ($sql_historial) {
            ...
            if ($sql_delete) {
                ...
                $body = sprintf(
                    '<h1>Solicitud Rechazada</h1><p>Su solicitud ha sido rechazada con los siguientes detalles:</p><ul><li>ID de Solicitud: %s</li><li>Solicitante: %s</li><li>Aula Solicitada: %s</li><li>Fecha y Hora de Inicio: %s</li><li>Fecha y Hora de Fin: %s</li></ul>',
                    $cod_ticket,
                    $solicitante,
                    $aula_solicitada,
                    $fecha_inicio,
