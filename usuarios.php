                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-warning" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdropMod<?php echo $datos->ID; ?>">Editar</a>
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="confirmarEliminacion(<?php echo $datos->ID; ?>)">Eliminar</a>
                                                </td>
                                            </tr>

                                            <!-- Dialogo de Confirmacion para Modificar Usuario -->
                                            <div class="modal fade" id="staticBackdropMod<?php echo $datos->ID; ?>"
                                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                                aria-labelledby="staticBackdropModLabel<?php echo $datos->ID; ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5"
                                                                id="staticBackdropModLabel<?php echo $datos->ID; ?>">
                                                                Modificar Usuario</h1>
                                                        </div>
                                                        <form method="POST"
                                                            action="./modificar_usuario.php?id=<?php echo $datos->ID; ?>">
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Nombre Completo</label>
                                                                    <input type="text" class="form-control" name="nombremod"
                                                                        placeholder="Nombre"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="usuariomod" placeholder="Usuario"
                                                                        value="<?php echo $datos->Usuario; ?>">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label">Password</label>
                                                                    <input type="text" class="form-control"
                                                                        name="contraseñamod" placeholder="Password"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" name="rolmod">
                                                                        <option value="<?php echo $datos->ID_Rol; ?>">
                                                                            <?php echo $datos->ID_Rol; ?></option>
                                                                        <option value="1">1- Administrador</option>
                                                                        <option value="2">2- Observador</option>
                                                                        <option value="3">3- Validador</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-warning"
                                                                    name="btnmodificar" value="ok">Modificar</button>
